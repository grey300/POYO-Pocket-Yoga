...
const CARDS = [
  { id: 1, pose: 'Tree', title: 'Tree', sanskrit: 'Vrksasana', blurb: 'Balance & focus', tracked: true },
  { id: 2, pose: 'Chair', title: 'Chair', sanskrit: 'Utkatasana', blurb: 'Legs & core strength', tracked: true },
  { id: 3, pose: 'Cobra', title: 'Cobra', sanskrit: 'Bhujangasana', blurb: 'Spine & chest opener', tracked: true },
  { id: 4, pose: 'Warrior', title: 'Warrior II', sanskrit: 'Virabhadrasana II', blurb: 'Stance & stamina', tracked: true },
  { id: 5, pose: 'Dog', title: 'Dog', sanskrit: 'Adho Mukha Svanasana', blurb: 'Full-body stretch', tracked: true },
  { id: 6, pose: 'Shoulderstand', title: 'Shoulderstand', sanskrit: 'Salamba Sarvangasana', blurb: 'Inversion & calm', tracked: true },
  { id: 7, pose: 'Triangle', title: 'Triangle', sanskrit: 'Trikonasana', blurb: 'Side-body opener', tracked: false },
  { id: 8, pose: 'Child', title: "Child's Pose", sanskrit: 'Balasana', blurb: 'Rest & reset', tracked: false },
];
